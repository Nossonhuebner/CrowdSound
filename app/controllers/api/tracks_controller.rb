class Api::TracksController < ApplicationController
  ...
  def index
    ...
    .includes(:comments, :reposters, :likers, artist: [:tracks, profile_pic_attachment: :blob]).first(12)
  end

  def show
    @track = Track.with_attached_file.with_attached_artwork
    .includes(:genre, :reposters, :likes, :likers, artist: [:tracks, :followers, :followees, :albums, profile_pic_attachment: :blob], comments: [user: [profile_pic_attachment: :blob]]).find(params[:id])
